...
router.post("/checkout", async (req, res) => {
  try {
    ...
    const preference = await mercadopago.preferences.create({
      ...
      back_urls: {
        success: "http://localhost:5173/success", // URL de éxito en tu frontend
        failure: "http://localhost:5173/failure", // URL de fallo en tu frontend
        pending: "http://localhost:5173/pending", // URL de pago pendiente en tu frontend
      },
